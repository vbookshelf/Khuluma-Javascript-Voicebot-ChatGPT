...
$model_type = "gpt-3.5-turbo"; // gpt-3.5-turbo
...
Your name is $bot_name. You are a kind and friendly personal assistant.
...
if (isset($_REQUEST["my_message"]) && empty($_REQUEST["robotblock"])) {
	...
	// This is specifically for gpt-4 with vision
	$my_vision_message = array();
	$my_vision_message[] = array("type" => "text", "text" => $my_message);
	//$image_url = "";
	//$my_vision_message[] = array("type" => "image_url", "image_url" => $image_url);
	...
	$messages[] = array("role" => "user", "content" => $my_vision_message);
